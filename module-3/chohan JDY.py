...
dice total to an even (cho) or odd (han) number  if the Player gets a
2 or a 7 on a dice roll,they get a 10 mon bonus..
''')
...
while True:  # Main game loop.
    ...
    print('    ', dice1, '-', dice2)
    # Check for a 2 or 7 special bonus roll:
    diceTotal = dice1 + dice2
    if diceTotal == 2 or diceTotal == 7:
        print('The total roll was', diceTotal, 'and you got a 10 mon bonus!')
        purse = purse + 10
